...
/**
 * FirstDrafter - First stage: Assign babies for the first draft round
...
class FirstDrafter {
  static assign(groups, highestIndex) {
    ...
    console.log(`\n[FirstDrafter] First draft starting`);
    ...
    console.log(`[FirstDrafter] ✓ Completed first draft with ${assignedBabies.size} picks`);
    return { assignedBabies, currentSeed };
  }
}

module.exports = FirstDrafter;
